...
import br.com.beholder.compras.maestro.dto.ProdutoEncontradoDTO;
...
public class MaestroService {
    ...
    public RelatorioDeBuscaDTO executarBusca(SolicitacaoDeBuscaDTO solicitacao) {
        ...
        ProdutoEncontradoDTO p2 = new ProdutoEncontradoDTO(solicitacao.nomeProduto() + " - Loja Y", 1399.00);
